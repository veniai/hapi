export default {
  ...
  'dialog.archive.blockedTitle': 'Archive needs attention',
  'dialog.archive.failedTitle': 'Archive failed',
  'dialog.archive.forceConfirm': 'Continue archive',
  'dialog.archive.forceCleanupDescription': 'Continuing will discard local worktree changes or unmerged commits and remove the worktree and branch.',
  'dialog.archive.forceArchiveOnlyDescription': 'Continuing will archive the conversation but leave the local worktree in place because it cannot be safely verified or cleaned.',
